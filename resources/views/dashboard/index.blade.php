                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex items-start space-x-4 flex-1">
                            ...
                            <div class="w-14 h-14 bg-gradient-to-br from-[#{{ $feature['color'] === 'madder' ? '931335' : '622032' }}] to-[#622032] rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                                ...
                                @case('voters')
                                <svg class="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                                     <path fill-rule="evenodd" d="M8.603 3.799A4.49 4.49 0 0112 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 013.498 1.307 4.491 4.491 0 011.307 3.498A4.49 4.49 0 0121.75 12c0 1.357-.6 2.573-1.549 3.397a4.49 4.49 0 01-1.307 3.498 4.491 4.491 0 01-3.498 1.307A4.49 4.49 0 0112 21.75a4.49 4.49 0 01-3.397-1.549 4.49 4.49 0 01-3.498-1.307 4.491 4.491 0 01-1.307-3.498A4.49 4.49 0 012.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 011.307-3.498 4.491 4.491 0 013.498-1.307zm7.007 6.153a.75.75 0 00-1.06-1.06l-3.007 3.007-1.44-1.44a.75.75 0 00-1.06 1.06l2 2a.75.75 0 001.06 0l3.5-3.5z" clip-rule="evenodd" />
                                </svg>
                                @break
