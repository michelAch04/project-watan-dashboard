                    ...
                    <div class="mb-3 pb-3 border-b border-[#f8f0e2]">
                        <div class="flex items-start gap-2 mb-2">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-[#622032]/60">{{ $request->teamSupportRequest->pwMember->voter->city->name }} @if($request->teamSupportRequest->pwMember->voter->register_number) • {{ $request->teamSupportRequest->pwMember->voter->register_number }} @endif</p>
                            </div>
                        </div>

                        <div class="flex items-center gap-2 text-xs text-[#622032]/60">
                            <span class="px-2 py-1 bg-[#fef9de] rounded" lang="ar">{{ $request->teamSupportRequest->subtype }}</span>
                            <span>•</span>
...
async function deleteDraft(requestId, requestNumber) {
    ...
    try {
        const response = await fetch(`/team-support/${requestId}`, {
            method: 'DELETE',
            headers: {
