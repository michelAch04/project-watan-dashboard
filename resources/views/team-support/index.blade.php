...
@section('title', 'Team Support Requests')
    ...
    <div class="safe-area py-6">
        <div class="page-container space-y-4">
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-2">
                ...
                <a href="{{ route('team-support.create') }}" class="btn-primary flex items-center justify-center w-full sm:w-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- Active Requests -->
                <a href="{{ route('team-support.active') }}"
                ...
                <!-- Drafts & Rejected -->
                <a href="{{ route('team-support.drafts') }}"
                   class="bg-white rounded-xl p-6 shadow-sm border border-[#f8f0e2] hover:shadow-md transition-all active:scale-[0.98]">
                    <div class="flex items-center justify-between mb-2">
                ...
                <!-- Completed -->
                <a href="{{ route('team-support.completed') }}"
                   class="bg-white rounded-xl p-6 shadow-sm border border-[#f8f0e2] hover:shadow-md transition-all active:scale-[0.98]">
                    <div class="flex items-center justify-between mb-2">
