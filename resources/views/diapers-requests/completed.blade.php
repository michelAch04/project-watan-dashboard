...
@section('title', 'Completed Diapers Requests')
        ...
        <div class="safe-area">
            <div class="page-container py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-lg sm:text-xl font-bold text-[#622032]">Completed Diapers Requests</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm border border-[#f8f0e2]">
                <div class="space-y-3">
                    <div class="w-full">
                        ...
                        <form method="GET" action="{{ route('diapers-requests.completed') }}" class="flex flex-row gap-2">
                            <input type="month"
                            ...
                            <div class="flex gap-2">
                                @if($month && $year)
                                <a href="{{ route('diapers-requests.completed') }}" class="btn-secondary whitespace-nowrap flex items-center">
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-[#f8f0e2]">
                    ...
                    <div class="space-y-2 text-xs mb-3">
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <span class="text-[#622032]">{{ Str::limit($request->diapersRequest->notes, 100) }}</span>
                        </div>
                        @endif
                    </div>
