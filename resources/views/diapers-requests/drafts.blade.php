...
@section('title', 'Diapers Drafts & Rejected')
                    ...
                    <div class="mb-3 pb-3 border-b border-[#f8f0e2]">
                        <div class="flex items-start gap-2 mb-2">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-[#622032]/60">{{ $request->diapersRequest->voter->city->name }} @if($request->diapersRequest->voter->register_number) • {{ $request->diapersRequest->voter->register_number }} @endif</p>
                            </div>
                        </div>
...
async function deleteDraft(requestId, requestNumber) {
    ...
    try {
        const response = await fetch(`/diapers-requests/${requestId}`, {
            method: 'DELETE',
            headers: {
