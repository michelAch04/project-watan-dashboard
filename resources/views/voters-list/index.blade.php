        ...
        <div class="page-container space-y-4">
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div class="text-sm text-blue-700">
                        <p class="font-semibold mb-1">Search to view voters</p>
                        <p>Enter at least 2 characters in the search field to load results.@if(auth()->user()->can('create_pw_members')) You can create PW members from voters listed here.@endif</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3" dir="rtl" lang="ar">
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-sm text-[#622032]/60">Enter at least 2 characters in the search field above to find voters</p>
                    @endif
                </div>
                @endforelse
            </div>
