                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center p-3 bg-[#fcf7f8] rounded-lg border border-[#f8f0e2] hover:bg-[#f8f0e2] transition-colors cursor-pointer">
                            <input type="checkbox" name="request_types[]" value="humanitarian"
                                {{ is_array($budget->request_type) && in_array('humanitarian', $budget->request_type) ? 'checked' : '' }}
                                class="w-4 h-4 text-[#931335] border-gray-300 rounded focus:ring-[#931335]">
                            <span class="ml-3 text-sm text-[#622032]">Humanitarian Requests</span>
                        </label>
                        <label class="flex items-center p-3 bg-[#fcf7f8] rounded-lg border border-[#f8f0e2] hover:bg-[#f8f0e2] transition-colors cursor-pointer">
                            <input type="checkbox" name="request_types[]" value="team_support"
                                {{ is_array($budget->request_type) && in_array('team_support', $budget->request_type) ? 'checked' : '' }}
                                class="w-4 h-4 text-[#931335] border-gray-300 rounded focus:ring-[#931335]">
                            <span class="ml-3 text-sm text-[#622032]">Team Support Requests</span>
                        </label>
                        <label class="flex items-center p-3 bg-[#fcf7f8] rounded-lg border border-[#f8f0e2] hover:bg-[#f8f0e2] transition-colors cursor-pointer">
                            <input type="checkbox" name="request_types[]" value="public"
                                {{ is_array($budget->request_type) && in_array('public', $budget->request_type) ? 'checked' : '' }}
                                class="w-4 h-4 text-[#931335] border-gray-300 rounded focus:ring-[#931335]">
                            <span class="ml-3 text-sm text-[#622032]">Public Facilities Requests</span>
                        </label>
                        <label class="flex items-center p-3 bg-[#fcf7f8] rounded-lg border border-[#f8f0e2] hover:bg-[#f8f0e2] transition-colors cursor-pointer">
                            <input type="checkbox" name="request_types[]" value="diapers"
                                {{ is_array($budget->request_type) && in_array('diapers', $budget->request_type) ? 'checked' : '' }}
                                class="w-4 h-4 text-[#931335] border-gray-300 rounded focus:ring-[#931335]">
