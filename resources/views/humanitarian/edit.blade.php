...
@endphp
<div class="min-h-screen bg-[#fcf7f8]" x-data="humanitarianEditForm(@json(auth()->user()->hasRole('hor')))" x-init="init()">
...
<script>
    ...
    function humanitarianEditForm(isHor) {
        return {
            form: {
            ...
            supportingDocuments: [],
            existingDocuments: @json($request->humanitarianRequest->supporting_documents ?? []),
            removedDocuments: [],
            fileUploadError: '',
